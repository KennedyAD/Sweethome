...
;
; SweetHome3D-6.4.6-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 6.4.6
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=SweetHome3D-6.4.6-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
ExtraDiskSpaceRequired=107000000
VersionInfoVersion=6.4.6.0
VersionInfoTextVersion=6.4.6
