...
;
; SweetHome3D-6.6.2-windows.exe setup program creator
...
AppVerName=Sweet Home 3D version 6.6.2
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=SweetHome3D-6.6.2-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
ExtraDiskSpaceRequired=104900000
VersionInfoVersion=6.6.2.0
VersionInfoTextVersion=6.6.2
