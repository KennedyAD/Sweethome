...
;
; SweetHome3D-7.0.2-windows.exe setup program creator
...
AppVersion=7.0.2
AppCopyright=Copyright (c) 2007-2022 eTeks
AppVerName=Sweet Home 3D version 7.0.2
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=SweetHome3D-7.0.2-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
ExtraDiskSpaceRequired=104900000
VersionInfoVersion=7.0.2.0
VersionInfoTextVersion=7.0.2
VersionInfoDescription=Sweet Home 3D Setup
VersionInfoCopyright=Copyright (c) 2007-2022 eTeks
