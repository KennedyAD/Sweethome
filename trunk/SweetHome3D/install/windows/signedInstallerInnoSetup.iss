...
;
; Sweet Home 3D, Copyright (c) 2007-2021 Emmanuel PUYBARET / eTeks <info@eteks.com>
;
; SweetHome3D-6.5.2-windows.exe setup program creator
...
AppVersion=6.5.2
AppCopyright=Copyright (c) 2007-2021 eTeks
AppVerName=Sweet Home 3D version 6.5.2
AppPublisher=eTeks
...
OutputDir=.
OutputBaseFilename=SweetHome3D-6.5.2-windows
Compression=lzma2/ultra64
SolidCompression=yes
ChangesAssociations=yes
ExtraDiskSpaceRequired=104900000
VersionInfoVersion=6.5.2.0
VersionInfoTextVersion=6.5.2
VersionInfoDescription=Sweet Home 3D Setup
VersionInfoCopyright=Copyright (c) 2007-2021 eTeks
